...
//        mSwipeRefreshLayout = (SwipeRefreshLayout) findViewById(R.id.swipe_refresh_layout);
        ...
        int columnCount = getResources().getInteger(R.integer.main_column_count);
...
//        mSwipeRefreshLayout.setRefreshing(mIsRefreshing);
    ...
    private class Adapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public long getItemId(int position) {
            ...
            return Long.valueOf(mCursor.getString(ArticleLoader.Query.SERVER_ID));
        }
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intent.putExtra(ArticleDetailActivity.SELECTED_ITEM_ID, getItemId(vh.getAdapterPosition()) + "");
